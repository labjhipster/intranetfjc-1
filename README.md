[![Gitpod ready-to-code](https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/jesusviloriag/intranetfjc)
...
To be able to run the project you need to install PostgreSQL and use the following configuration:

    url: jdbc:postgresql://localhost:5432/fjcintranet
    database name: fjcintranet
    username: postgres
    password: 321321

The project will create all the tables in the database.

You can also edit database credentials in `src/main/resources/config/application-dev.ym` in the `datasource` section.
...
To build the final jar and optimize the fjcintranet application for production, run:
